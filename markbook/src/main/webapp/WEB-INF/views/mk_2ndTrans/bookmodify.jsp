...
<main>
	...
	<!-- 책 수정 폼  -->
	<form action="" method="post" id="2ndbookR" name="2ndbookRegister">
		<div class="container" style="padding-left: 100px;">
			<div class="row">
				<div class="col-lg-8 col-md-8">
					<div class="single-element-widget mt-30">
						<h2 class="mb-30">Seller id</h2>
						<input type="text" name="m_id" value="${m_id }" class="single-input" readonly="readonly">
					</div>
					<div class="single-element-widget mt-30">
						...
						<div class="mt-5">
							...
							<input type="text" name="b2_writer" value="${bvo.b2_writer }"
								onfocus="this.placeholder = ''"
						...
						<div class="mt-5">
							...
							<textarea name="b2_content" class="single-textarea">${bvo.b2_content }</textarea>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-4 mt-sm-30">
					...
					<div class="mt-5">
							...
							<input type="text" name="b2_publisher" value="${bvo.b2_publisher }"
								onfocus="this.placeholder = ''"
					...
					<div class="form-group mt-3">
                         ...
                         <button type="button" class="button button-contactForm boxed-btn" onclick="location.href='./bookdelete?b2_num=${bvo.b2_num }';">삭제하기</button>
