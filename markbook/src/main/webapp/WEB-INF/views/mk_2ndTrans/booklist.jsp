                        ...
                        <div class="single-listing">
                            ...
                            <aside class="left_widgets p_filter_widgets price_rangs_aside sidebar_box_shadow mb-40">
                                ...
                                <div class="widgets_inner">
                                    <div class="range_item">
                                        <span class="irs js-irs-0"><span class="irs"><span class="irs-line" tabindex="-1"><span class="irs-line-left"></span><span class="irs-line-mid"></span><span class="irs-line-right"></span></span><span class="irs-min" style="visibility: hidden;">$ 0</span><span class="irs-max" style="visibility: visible;">$ 1.000</span><span class="irs-from" style="visibility: visible; left: 0%;">$ 0</span><span class="irs-to" style="visibility: visible; left: 41.8367%;">$ 500</span><span class="irs-single" style="visibility: hidden; left: 13.9796%;">$ 0 - $ 500</span></span><span class="irs-grid"></span><span class="irs-bar" style="left: 3.06122%; width: 46.9388%;"></span><span class="irs-shadow shadow-from" style="display: none;"></span><span class="irs-shadow shadow-to" style="display: none;"></span><span class="irs-slider from" style="left: 0%;"></span><span class="irs-slider to type_last" style="left: 46.9388%;"></span></span><input type="text" class="js-range-slider irs-hidden-input" value="" readonly="">
                            ...
                            <div class="select-job-items2 mb-30">
                                <div class="col-xl-12">
                                    ...
                                    </select><div class="nice-select" tabindex="0"><span class="current">Filter by Rating</span><ul class="list"><li data-value="" class="option selected">Filter by Rating</li><li data-value="" class="option">5 Star Rating</li><li data-value="" class="option">4 Star Rating</li><li data-value="" class="option">3 Star Rating</li><li data-value="" class="option">2 Star Rating</li><li data-value="" class="option">1 Star Rating</li></ul></div>
                                </div>
                            </div>
                           ...
                           <div class="product_page_tittle">
                            <div class="short_by">
                                <select name="#" id="product_short_list" style="display: none;">
                                    ...
                                    <option>Old</option>
                                    <option>Price</option>
                                </select><div class="nice-select" tabindex="0"><span class="current">Browse by popularity</span><ul class="list"><li data-value="Browse by popularity" class="option selected">Browse by popularity</li><li data-value="Name" class="option">Name</li><li data-value="NEW" class="option">NEW</li><li data-value="Old" class="option">Old</li><li data-value="Price" class="option">Price</li></ul></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="subscribe-area">
    <div class="container">
        <div class="subscribe-caption text-center  subscribe-padding section-img2-bg" data-background="assets/img/gallery/section-bg1.jpg" style="background-image: url(&quot;assets/img/gallery/section-bg1.jpg&quot;);">
