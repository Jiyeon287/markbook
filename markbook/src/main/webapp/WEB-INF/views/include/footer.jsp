<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="footer-wrappper section-bg">
     <div class="footer-area footer-padding">
                     ...
                     <div class="single-footer-caption mb-50">
                         <div class="single-footer-caption mb-30">
                             ...
                             <div class="footer-logo mb-25">
                                 <a href="${pageContext.request.contextPath }/index"><img src="${pageContext.request.contextPath }/resources/assets/img/logo/logo3.png" alt=""></a>
                             </div>
         ...
         <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
             <div class="single-footer-caption mb-50">
                 <div class="footer-tittle" style="padding-top: 21px;">
                     <h4></h4>
                     <ul class="mb-20">
                         <li><a href="${pageContext.request.contextPath }/mk_requestBoard/add">BookRequests</a></li>
                         <li><a href="${pageContext.request.contextPath }/mk_booktest/booktest1">BookTest</a></li>
                         <li><a href="${pageContext.request.contextPath }/mk_2ndTrans/booklist">BookDeals</a></li>
                         <li><a href="#">Blog</a></li>
                         <li><a href="#">Contact</a></li>
                     </ul>
                 </div>
         ...
         <div class="row d-flex align-items-center">
             <div class="col-xl-12 ">
                 <div class="footer-copy-right text-center">
                    Copyright ©<script>document.write(new Date().getFullYear());</script> WillHeroes All rights reserved | This Site is made with <i class="fa fa-heart color-danger" aria-hidden="true"></i> by <a href="https://github.com/WillHeroes/markbook" style="color: red" target="_blank" rel="nofollow noopener">WillHeroes</a>
