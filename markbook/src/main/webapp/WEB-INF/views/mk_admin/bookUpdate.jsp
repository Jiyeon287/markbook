...
<div class="content">
    ...
    <i class="gd-info-alt icon-text mr-2 mt-1" style="margin-top: 2px;"></i> -->
									...
									<div>
										...
										<div class="form-check position-relative mb-2">
											<input type="radio" class="form-check-input d-none"
												id="customRadioboxes1" name="b_category" value="문학"> <label
										...
										<div class="form-check position-relative mb-2">
											<input type="radio" class="form-check-input d-none"
												 id="customRadioboxes2" name="b_category" value="비문학"> <label
												class="radio radio-xxs form-check-label ml-1"
												for="customRadioboxes2" data-icon="" >비문학</label>
										</div>
										<div class="form-check position-relative mb-2">
											<input type="radio" class="form-check-input d-none"
												id="customRadioboxes3" name="b_category" value="자기계발"> <label
												class="radio radio-xxs form-check-label ml-1"
												for="customRadioboxes3" data-icon="" >자기계발</label>
										</div>
										<div class="form-check position-relative mb-2">
											<input type="radio" class="form-check-input d-none"
												id="customRadioboxes4" name="b_category" value="수험서"> <label
												class="radio radio-xxs form-check-label ml-1"
												for="customRadioboxes4" data-icon="" >수험서</label>
										</div>
										<div class="form-check position-relative mb-2">
											<input type="radio" class="form-check-input d-none"
												id="customRadioboxes5" name="b_category" value="잡지"> <label
												class="radio radio-xxs form-check-label ml-1"
												for="customRadioboxes5" data-icon="" >잡지</label>
										</div>
										<div class="form-check position-relative mb-2">
											<input type="radio" class="form-check-input d-none"
												id="customRadioboxes6" name="b_category" value="기타"> <label
												class="radio radio-xxs form-check-label ml-1"
									...
									<div class="form-group">
										...
										<textarea class="form-control"
											id="b_writer" name="b_writer" rows="1"></textarea>
									</div>
									<div class="form-group">
